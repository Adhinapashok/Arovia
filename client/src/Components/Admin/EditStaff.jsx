...
function EditStaff() {
  ...
  const validateForm = () => {
    ...
    } else if (!mobileRegex.test(formData.phoneno)) {
    ...
    // Photo validation (only if new photo is uploaded)
    if (formData.photo) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${apiUrl}editstaff`, formDataToSend, {
      ...
      if (res.data.status === "ok") {
        ...
        alert(res.data.message || 'Error updating staff')
      }
    } catch (error) {
  ...
  return (
    <div className="edit-staff-container">
      <div className="edit-header">
        <button className="back-btn" onClick={() => navigate('/home/viewstf')}>
      ...
      <form onSubmit={onSubmit} className="edit-staff-form">
        ...
        <div className="form-actions">
          <button type="button" className="cancel-btn" onClick={() => navigate('/home/viewstf')}>
