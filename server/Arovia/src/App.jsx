// App.jsx - Updated with nested user routes
...
import DoctorViewStaff from './Components/Doctor/DoctorViewStaff.jsx'
import UsviewMedicine from './Components/User/UsviewMedicine.jsx'
    ...
    <>
      <div style={{ padding: '0', margin: '0', boxSizing: 'border-box' }}>
        <Routes>
          ...
          {/* Admin Routes - Nested under /home */}
          ...
          {/* Doctor Routes - Nested under /drhome */}
          <Route path='/drhome' element={<DoctorHome />}>
            ...
            <Route path='drvistf' element={<DoctorViewStaff/>}/>
          </Route>

          {/* User Routes - Nested under /userhome */}
          <Route path='/userhome' element={<UserHome />}>
            <Route index element={<UserHome />} />
            <Route path='usviewdr' element={<ViewDoctors />} />
            <Route path='usviewbook' element={<ViewBookings />} />
            <Route path='usrfeedback' element={<Feedback />} />
            ...
            <Route path='usviewmed' element={<UsviewMedicine />} />

          </Route>

          {/* Edit Profile - Not nested (standalone) */}
        </Routes>
      </div>
    </>
  );
